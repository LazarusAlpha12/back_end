...
public class PedidoController {
    ...
    @PreAuthorize("hasRole('REPARTIDOR') or hasRole('ADMIN') or hasRole('OPERADOR')")
    ...
    @PreAuthorize("hasRole('ADMIN') or hasRole('OPERADOR')or hasRole('ADMIN') or hasRole('OPERADOR')")
